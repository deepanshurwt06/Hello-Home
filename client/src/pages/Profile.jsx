  ...
  return (
    <div className="flex flex-col max-w-lg mx-auto p-5 gap-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button className="p-3 bg-slate-800 font-medium text-white rounded-md uppercase hover:opacity-95 disabled:opacity-80">
          Update
        </button>

        <Link
          className="bg-green-700 hover:opacity-95 text-white p-3 rounded-md uppercase text-center font-medium "
          to={"/create-listing"}
        >
          create listing
        </Link>
      ...
      <Link
        to={"/show-listing"}
        className="text-white uppercase text-center  p-2 rounded-lg sm:left-250 top-5 font-semibold cursor-pointer bg-green-800"
      >
        show Listing
      </Link>
